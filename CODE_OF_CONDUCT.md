...
This project exists to serve people with disabilities. Accessibility of the
community itself (in communication, documentation, and patience with
different ways of participating) is part of that mission, not an add-on.
...
- Unsolicited medical advice, or dismissing a person's account of their own
  disability or needs
...
issues, discussions, pull requests, and any future chat spaces), and also
...
reported to the project maintainer at owenpkent@gmail.com. All complaints
...
2. **Warning.** A warning with consequences for continued behavior,
   including avoiding interaction with the people involved for a specified
   period.
